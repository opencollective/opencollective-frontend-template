...
export default function ServerSidePage({ session }: { session: Session }) {
  ...
  return (
    <Layout>
      ...
      <p>
        Using <strong>unstable_getServerSession()</strong> in <strong>unstable_getServerSideProps()</strong> is the
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  return {
    props: {
      session: await unstable_getServerSession(context.req, context.res, NextAuth.authOptions),
    },
  };
}
