...
export default function Updates({ currentTag, openCollectiveModal }) {
  ...
  return (
    <div>
      <h1 className="mb-6  text-xl font-bold text-gray-600 md:text-4xl">Updates from collectives</h1>
      <Flipper flipKey={currentTag}>
        <div className="min-h-[440px] space-y-4 md:min-h-[560px]">
          {sortedUpdates
            ...
            .map(update => {
              return (
                <Flipped flipId={update.createdAt} key={update.createdAt}>
                  <div className="fadeIn flex flex-col gap-1 rounded-lg bg-white p-2 md:p-4">
                    <a
                      className=" relative mb-0  block space-y-2 overflow-hidden rounded-lg p-2 transition-colors duration-100 hover:bg-gray-50 md:p-4 "
                      href={`https://opencollective.com/${update.account.slug}/updates/${update.slug}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <div className="flex items-center justify-between gap-6">
                        <h4 className="flex-shrink overflow-hidden text-ellipsis whitespace-nowrap  text-base font-medium text-gray-900 group-hover:underline md:text-xl">
                          {update.title}
                        </h4>
                      ...
                      <p className="overflow-hidden text-ellipsis whitespace-nowrap text-sm text-gray-500 md:text-base">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm font-medium text-gray-800">
                        <button
                          className=" flex items-center gap-2 rounded-md px-2 py-2 hover:bg-gray-50 md:px-4"
                          type="button"
                        ...
                        <span className="align-items hidden gap-2 md:flex">
                          <img
                      ...
                      <p className="block flex-shrink-0  text-sm text-gray-600 md:hidden">
